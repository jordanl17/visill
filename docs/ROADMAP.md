...
- **Phase 6.1 - Proposed.** Closes the gaps the Phase 6 integration gate surfaced: `defineVisillConfig` wires root/input/outDir/plugins; tests across all packages standardize on `test/` per ADR 0024; CI re-greens. See PRD 006.1.
